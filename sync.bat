...
copy /y models.html www\ >nul
copy /y class-recorder.html www\ >nul
...
copy /y models.html android\app\src\main\assets\public\ >nul
copy /y class-recorder.html android\app\src\main\assets\public\ >nul
